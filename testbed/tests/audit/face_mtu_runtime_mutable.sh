...
check_grep 'fn set_send_mtu' crates/spec/ndn-faces/src/net 'UdpFace::set_send_mtu override'

# (e) ShmFace declares Immutable for both setters.
check_grep 'Immutable' crates/spec/ndn-faces/src/local 'ShmFace Immutable setter response'
