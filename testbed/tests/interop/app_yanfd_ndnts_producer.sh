...
#
# Retry the fetch: NDNts (Node.js) startup + rib/register + yanfd's
# RIB→FIB propagation timing varies under CI load.  Three attempts with
# 2s back-off absorbs the variance without significantly slowing the
# happy path.
SUCCESS=0
RESULT=""
