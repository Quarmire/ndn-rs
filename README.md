...
<p align="center">
  <img src="https://img.shields.io/badge/tests-1900%2B%20%2F%20~25s-brightgreen" alt="tests">
...
| [ndn-ext](https://github.com/Quarmire/ndn-ext) | extensions: non-standard faces, routing, discovery, strategies, compute, service stack, bindings (wasm/python/FFI) |
| [ndn-fwd](https://github.com/Quarmire/ndn-fwd) | the forwarder binary + CLIs |
| [ndn-radio-drivers](https://github.com/Quarmire/ndn-radio-drivers) | USB Wi-Fi / LoRa radio drivers + the radio-foundation crates (moved here from ndn-rs, 2026-08) |
...
| [ndn-course](https://github.com/Quarmire/ndn-course) | applied-Rust teaching course built on ndn-rs |
...
(Thirteen repos in all — the table skips one private research repo. The
authoritative inventory is the workspace-level `STATE.md` in the ndn-workspace
checkout, regenerated by `tools/gen_state.py`.)
...
cargo nextest run --workspace     # ~1900 tests, ~25s (falls back to cargo test)
