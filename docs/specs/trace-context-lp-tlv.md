...
> **Reference impl:** [`crates/core/ndn-packet/src/lp/trace_context.rs`](../../crates/core/ndn-packet/src/lp/trace_context.rs).
...
- **Codec:** complete (`crates/core/ndn-packet/src/lp/trace_context.rs`).
- **Engine inject/extract:** see `crates/forwarding/ndn-engine/src/` —
