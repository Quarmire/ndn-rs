...
| `cs/miss` | 543 ns | ±1 ns |
| | | |
| `cs_insert/insert_new` | 11.25 µs | ±19.72 µs |
| `cs_insert/insert_replace` | 945 ns | ±3 ns |
| | | |
| `data_pipeline/4` | 1.82 µs | ±38 ns |
| `data_pipeline/8` | 2.22 µs | ±47 ns |
| | | |
| `decode/data/4` | 414 ns | ±0 ns |
| `decode/data/8` | 499 ns | ±1 ns |
| `decode/interest/4` | 454 ns | ±1 ns |
| `decode/interest/8` | 546 ns | ±2 ns |
| | | |
| `decode_throughput/4` | 445.12 µs | ±5.33 µs |
| `decode_throughput/8` | 518.88 µs | ±700 ns |
| | | |
| `fib/lpm/10` | 34 ns | ±0 ns |
| `fib/lpm/100` | 97 ns | ±0 ns |
| `fib/lpm/1000` | 97 ns | ±0 ns |
| | | |
| `interest_pipeline/cs_hit` | 950 ns | ±5 ns |
| `interest_pipeline/no_route/4` | 1.37 µs | ±47 ns |
| `interest_pipeline/no_route/8` | 1.52 µs | ±18 ns |
| | | |
| `large/blake3-rayon/hash/1MB` | 116.70 µs | ±2.25 µs |
| `large/blake3-rayon/hash/256KB` | 37.47 µs | ±1.58 µs |
| `large/blake3-rayon/hash/4MB` | 436.78 µs | ±4.70 µs |
| `large/blake3-single/hash/1MB` | 247.59 µs | ±1.72 µs |
| `large/blake3-single/hash/256KB` | 61.51 µs | ±731 ns |
| `large/blake3-single/hash/4MB` | 996.32 µs | ±1.90 µs |
| `large/sha256/hash/1MB` | 659.71 µs | ±646 ns |
| `large/sha256/hash/256KB` | 164.68 µs | ±273 ns |
| `large/sha256/hash/4MB` | 2.64 ms | ±4.68 µs |
| | | |
| `lru/evict` | 191 ns | ±1 ns |
| `lru/evict_prefix` | 2.11 µs | ±2.87 µs |
| `lru/get_can_be_prefix` | 298 ns | ±0 ns |
| `lru/get_hit` | 204 ns | ±0 ns |
| `lru/get_miss_empty` | 137 ns | ±0 ns |
| `lru/get_miss_populated` | 182 ns | ±0 ns |
| `lru/insert_new` | 2.31 µs | ±1.73 µs |
| `lru/insert_replace` | 372 ns | ±0 ns |
| | | |
| `name/display/components/4` | 452 ns | ±1 ns |
| `name/display/components/8` | 883 ns | ±9 ns |
...
| `name/parse/components/12` | 680 ns | ±32 ns |
| `name/parse/components/4` | 233 ns | ±3 ns |
| `name/parse/components/8` | 434 ns | ±2 ns |
| `name/tlv_decode/components/12` | 338 ns | ±2 ns |
| `name/tlv_decode/components/4` | 148 ns | ±0 ns |
| `name/tlv_decode/components/8` | 232 ns | ±0 ns |
| | | |
| `pit/aggregate` | 2.30 µs | ±133 ns |
| `pit/new_entry` | 1.25 µs | ±6 ns |
| | | |
| `pit_match/hit` | 1.61 µs | ±4 ns |
...
| `sharded/insert/1` | 2.79 µs | ±1.20 µs |
| `sharded/insert/16` | 2.35 µs | ±2.04 µs |
| `sharded/insert/4` | 2.98 µs | ±1.46 µs |
| `sharded/insert/8` | 2.80 µs | ±1.33 µs |
| | | |
...
| `signing/blake3-keyed/sign_sync/4KB` | 3.54 µs | ±1 ns |
| `signing/blake3-keyed/sign_sync/500B` | 617 ns | ±2 ns |
| `signing/blake3-keyed/sign_sync/8KB` | 4.81 µs | ±3 ns |
...
| `signing/blake3-plain/sign_sync/4KB` | 3.53 µs | ±1 ns |
| `signing/blake3-plain/sign_sync/500B` | 623 ns | ±0 ns |
| `signing/blake3-plain/sign_sync/8KB` | 4.79 µs | ±3 ns |
| `signing/ed25519/sign_sync/100B` | 20.63 µs | ±32 ns |
| `signing/ed25519/sign_sync/1KB` | 24.10 µs | ±84 ns |
| `signing/ed25519/sign_sync/2KB` | 27.88 µs | ±117 ns |
| `signing/ed25519/sign_sync/4KB` | 35.02 µs | ±47 ns |
| `signing/ed25519/sign_sync/500B` | 22.15 µs | ±47 ns |
| `signing/ed25519/sign_sync/8KB` | 50.09 µs | ±410 ns |
...
| `signing/hmac/sign_sync/500B` | 512 ns | ±5 ns |
| `signing/hmac/sign_sync/8KB` | 5.26 µs | ±2 ns |
...
| `signing/sha256-digest/sign_sync/8KB` | 5.07 µs | ±1 ns |
| | | |
| `validation/cert_missing` | 200 ns | ±0 ns |
| `validation/schema_mismatch` | 151 ns | ±0 ns |
| `validation/single_hop` | 46.12 µs | ±80 ns |
| | | |
| `validation_stage/cert_via_anchor` | 43.43 µs | ±89 ns |
| `validation_stage/disabled` | 615 ns | ±1 ns |
| | | |
| `verification/blake3-keyed/verify/100B` | 299 ns | ±0 ns |
| `verification/blake3-keyed/verify/1KB` | 1.32 µs | ±1 ns |
| `verification/blake3-keyed/verify/2KB` | 2.51 µs | ±7 ns |
| `verification/blake3-keyed/verify/4KB` | 3.65 µs | ±3 ns |
| `verification/blake3-keyed/verify/500B` | 734 ns | ±0 ns |
| `verification/blake3-keyed/verify/8KB` | 4.91 µs | ±12 ns |
| `verification/blake3-plain/verify/100B` | 304 ns | ±0 ns |
| `verification/blake3-plain/verify/1KB` | 1.32 µs | ±0 ns |
| `verification/blake3-plain/verify/2KB` | 2.51 µs | ±3 ns |
| `verification/blake3-plain/verify/4KB` | 3.64 µs | ±23 ns |
| `verification/blake3-plain/verify/500B` | 740 ns | ±0 ns |
| `verification/blake3-plain/verify/8KB` | 4.91 µs | ±5 ns |
| `verification/ed25519/verify/100B` | 41.52 µs | ±97 ns |
| `verification/ed25519/verify/1KB` | 43.60 µs | ±103 ns |
| `verification/ed25519/verify/2KB` | 45.39 µs | ±180 ns |
| `verification/ed25519/verify/4KB` | 49.06 µs | ±787 ns |
| `verification/ed25519/verify/500B` | 42.73 µs | ±1.14 µs |
| `verification/ed25519/verify/8KB` | 57.45 µs | ±252 ns |
| `verification/sha256-digest/verify/100B` | 102 ns | ±1 ns |
| `verification/sha256-digest/verify/1KB` | 662 ns | ±5 ns |
