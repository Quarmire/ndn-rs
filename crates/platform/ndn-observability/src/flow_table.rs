...
/// Maps name prefixes to their historically best face. Consulted by
/// `MultiRadioStrategy` as a fast path that bypasses the FIB; flushed when a
/// face's channel assignment changes.
...
impl FlowTable {
    ...
    /// Drop entries whose preferred face equals `face_id`.
...
mod tests {
    ...
    fn make_entry(comp: &'static str, face: u64, tput: f32) -> FlowEntry {
