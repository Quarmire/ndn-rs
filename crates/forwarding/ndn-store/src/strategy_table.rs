...
/// Maps name prefixes to strategy instances via longest-prefix match. Runs
/// alongside the FIB. `S` is generic (typically `dyn Strategy`) to avoid a
/// dependency on `ndn-strategy`.
