...
/// Parsed Interest fields without `ParametersSha256DigestComponent` validation.
/// Discovery protocols trust the link and skip the digest requirement.
...
/// Strip LP framing if present; return inner fragment or `raw` unchanged.
